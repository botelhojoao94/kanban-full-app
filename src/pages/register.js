...
export default function Register() {
    ...
    const { registerEmailError, signUp } = useContext(AuthContext)
            ...
            <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit(handleSignUp)}>
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-purple-900 focus:border-purple-900 focus:z-10 sm:text-sm"
                                    placeholder="E-mail"
                                />
                            </div>
                            <div>
                        ...
                        {registerEmailError ? <span className="text-red-500 text-xs">Este email já está sendo usado!</span> : null}
